...
export const runnersHeartPageKo: RunnersHeartPageContent = {
  ...
  seoDescription:
    'Apple Watch 햅틱, 개인화된 존 계산, iPhone 분석 화면까지 갖춘 심박수 존 러닝 코치 앱.',
  heroEyebrow: 'Apple Watch + iPhone 러닝 코치',
  appName: 'RunnersHeart',
  heroTagline: '심박수 존 러닝 코치',
  heroDescription:
    '페이스를 감으로 맞추지 않아도 됩니다. RunnersHeart는 Apple Watch에서 심박수 존 변화를 바로 알려주고, iPhone에서는 러닝 기록을 한눈에 이해하기 쉽게 정리해줍니다.',
  ...
  demoDescription:
    '이번 한국어 데모 영상에서는 Apple Watch와 iPhone에 새로 적용된 존 게이지 흐름을 볼 수 있습니다. 달리는 동안 어떤 피드백을 받게 되는지 자연스럽게 확인해보세요.',
  demoCalloutTitle: '이번 흐름에서 달라진 점',
  demoCalloutBody:
    '이제 존 상태를 더 빠르게 알아차릴 수 있고, 게이지 움직임도 훨씬 안정적으로 느껴집니다. 목표 강도를 유지하도록 돕는 피드백도 한층 또렷해졌습니다.',
  highlightPoints: [
    '운동 중 1초마다 갱신되는 실시간 심박수',
    '심박수 존마다 다르게 울리는 햅틱 패턴',
    'iPhone에서 보는 TRIMP 기반 훈련 부하 분석',
    '더 깔끔하고 선명해진 운동 공유 카드',
    '감이 아니라 강도로 훈련하고 싶은 러너를 위한 구성',
  ],
  featureKicker: '러너가 쓰는 이유',
  featureTitle: '강도에 맞춰 달리기 쉽게 만들었습니다',
  featureDescription:
    '손목에서 바로 받는 햅틱부터 iPhone의 상세 분석까지, 실제 러닝 흐름에 맞게 군더더기 없이 다듬었습니다.',
  features: [
    {
      icon: '💓',
      title: '실시간 존 피드백',
      description:
        'Apple Watch 햅틱으로 존 변화를 바로 느끼면서, 화면을 자주 보지 않아도 페이스를 조절할 수 있습니다.',
    },
    {
      icon: '🎯',
      title: '개인화된 심박수 존',
      description:
        '%MaxHR 또는 HRR 방식 중에서 골라, 내 몸 상태에 맞는 목표 존을 설정할 수 있습니다.',
    },
    {
      icon: '📈',
      title: '개선된 존 게이지',
      description:
        '게이지 움직임이 더 부드러워지고 유지 피드백도 좋아져서, 목표 강도를 지키기가 한결 편해졌습니다.',
    },
    {
      icon: '🗺️',
      title: '상세 운동 분석',
      description:
        '러닝이 끝난 뒤에는 iPhone에서 경로, 심박 흐름, 존 체류 시간, 훈련 부하를 차분히 살펴볼 수 있습니다.',
    },
    {
      icon: '🔄',
      title: 'Watch ↔ iPhone 동기화',
      description:
        '목표 존과 거리 목표가 두 기기 사이에서 자연스럽게 동기화되어, 설정을 바꿔도 흐름이 끊기지 않습니다.',
    },
    {
      icon: '🔒',
      title: '기기 안에 머무는 데이터',
      description:
        '회원가입도 서버도 없습니다. 건강 데이터와 운동 기록은 사용자의 기기에만 저장됩니다.',
    },
  ],
  galleryKicker: '앱 화면',
  galleryTitle: '업데이트된 화면을 한눈에 살펴보세요',
  galleryDescription:
    '러닝 전 준비부터 러닝 후 분석까지, 자주 보게 되는 핵심 화면을 한 번에 살펴볼 수 있게 정리했습니다.',
  galleryItems: [
    {
      src: sharedGallery.watchStandby,
      alt: 'RunnersHeart Apple Watch 대기 화면',
      title: '달리기 전 준비',
      description: 'Apple Watch에서 운동을 빠르게 준비하고 바로 시작할 수 있습니다.',
      device: 'Apple Watch',
    },
    {
      src: sharedGallery.watchRunning,
      ...
      title: '실시간 러닝 화면',
      description: '러닝 중 페이스, 거리, 존 피드백을 직관적으로 확인할 수 있습니다.',
      device: 'Apple Watch',
    },
    {
      src: sharedGallery.iphoneToday,
      ...
      title: 'Today 대시보드',
      description: '최근 훈련 흐름을 더 정돈된 홈 화면에서 바로 이어서 볼 수 있습니다.',
      device: 'iPhone',
    },
    {
      src: sharedGallery.iphoneRecords,
      ...
      title: '운동 기록 목록',
      description: '지난 러닝을 훑어보며 꾸준함과 패턴을 비교하기 좋습니다.',
      device: 'iPhone',
    },
    {
      src: sharedGallery.iphoneRecordDetail,
      ...
      title: '기록 상세 분석',
      description: '경로, 심박 흐름, 존 체류 시간, 훈련 부하를 한 화면에서 확인할 수 있습니다.',
      device: 'iPhone',
    },
    {
      src: sharedGallery.iphoneSettings,
      ...
      title: '개인화 설정',
      description: 'HRR, 목표 존 관련 옵션, 앱 설정을 내 훈련 방식에 맞게 조정할 수 있습니다.',
      device: 'iPhone',
    },
  ],
  summaryKicker: '달리기에 더 집중할 수 있게',
  summaryTitle: '덜 방해받고, 더 정확하게 달리세요.',
  summaryDescription:
    'RunnersHeart는 러닝 중에는 손목에서 조용히 방향을 잡아주고, 끝난 뒤에는 결과를 이해하기 쉽게 정리해주는 앱입니다. 이번 업데이트에서는 그 흐름을 더 자연스럽고 또렷하게 다듬었습니다.',
  summaryStats: [
    { value: 'HRR', label: '고급 존 계산 옵션' },
    { value: 'TRIMP', label: 'iPhone에서 확인하는 훈련 부하 분석' },
    { value: '오프라인', label: '달리는 동안 인터넷 없이 사용 가능' },
  ],
  ctaTitle: '이제 목표 존에 맞춰 달려보세요',
  ctaDescription:
